...
from t77_date.timedelta import timedelta_to_str
...
class TimedeltaToSecondsTestCase(unittest.TestCase):
    ...
    def test_seconds(self):
        ...
        self.assertEqual(timedelta_to_str(val, True), '00:00:01.000001')
    ...
    def test_1_day(self):
        ...
        self.assertEqual(timedelta_to_str(val, True), '24:00:00.000001')
    ...
    def test_5_days(self):
        ...
        self.assertEqual(timedelta_to_str(val, True), '120:00:00.000001')
